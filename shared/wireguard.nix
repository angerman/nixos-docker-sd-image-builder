{ config, pkgs, ... }:
{
  ...
  networking.wireguard.interfaces = {
    ...
    wg0 = {
      ...
      # recommended.
      privateKey = "CAvsXXN6WX+KjAkZUwzRCMq08N4vlUQW7iCHIxeHk3U=";
      # pubkey: k4bLSPAe+wZ1NP0Osj7XsW6yIPeBClR9pUD8BAjYDnw=
      ...
      peers = [
        ...
        { # Feel free to give a meaning full name
          ...
          publicKey = "DlVZHtNWfNHJi27Bp8oeF/63Qw79qskCTDU6tiRGvlE="; #"";
